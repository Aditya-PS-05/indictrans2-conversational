...
python src/train/make_soup.py 0.6 ft_it2_ml_soup ft_it2_ml > ml_soup_build.log 2>&1
sleep 5
...
python src/eval/ml_eval.py ai4bharat/indictrans2-en-indic-1B "$LANGS" >> ml_results.log 2>&1
echo "===== FT (pure multilingual) =====" >> ml_results.log
python src/eval/ml_eval.py ft_it2_ml "$LANGS" >> ml_results.log 2>&1
echo "===== SOUP alpha=0.6 =====" >> ml_results.log
python src/eval/ml_eval.py ft_it2_ml_soup "$LANGS" >> ml_results.log 2>&1
