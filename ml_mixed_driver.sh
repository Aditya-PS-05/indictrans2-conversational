...
python make_soup.py 0.6 ft_it2_ml_mixed_soup ft_it2_ml_mixed > ml_mixed_soup_build.log 2>&1
sleep 5

LANGS="hin_Deva,tam_Taml,ben_Beng,mar_Deva,mal_Mlym"
echo "===== MIXED FT =====" > ml_mixed_results.log
python ml_eval.py ft_it2_ml_mixed "$LANGS" >> ml_mixed_results.log 2>&1
echo "===== MIXED SOUP alpha=0.6 =====" >> ml_mixed_results.log
python ml_eval.py ft_it2_ml_mixed_soup "$LANGS" >> ml_mixed_results.log 2>&1
