...
python ml_eval.py ai4bharat/indictrans2-en-indic-1B "$LANGS" 200 >> all21_results.log 2>&1
echo "===== MIXED SOUP =====" >> all21_results.log
python ml_eval.py ft_it2_ml_mixed_soup "$LANGS" 200 >> all21_results.log 2>&1
